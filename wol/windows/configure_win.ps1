# 1. Downloads and loads REG file containing all necessary options for enabling WoL on Ethernet controller: Intel Corporation I211 Gigabit Network Connection (rev 03) card
# 2. Configures windows to start SSH server
# 3. Allows RDP connections
# on windows 10.
...
Write-Output "Public SSH key copied and access for administrators granted successfully for public keys file."
